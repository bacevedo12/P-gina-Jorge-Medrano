...
const SobreMi = () => {
    return (
        ...
        <section className="estudios pb-5">
            ...
            <div className="">
            <h4 className="subtituloEstudios text-start ms-3 fs-md-3 fs-sm-4">TÍTULO PROFESIONAL</h4>
            <div className="divider bg-danger ms-3 mb-3"></div>
            <p className="text-start ms-3">Médico Cirujano, Universidad Antofagasta. 2011</p>
            <h4 className="subtituloEstudios text-start ms-3 fs-md-3 fs-sm-4 ">ESPECIALIDAD</h4>
            <div className="divider bg-danger ms-3 mb-3"></div>
            <p className="text-start ms-3">Médico Especialista en Cirugía General, Universidad Concepción. 2015-2018</p>
            <h4 className="subtituloEstudios text-start ms-3 fs-md-3 fs-sm-4">SUBESPECIALIDAD</h4>
            <div className="divider bg-danger ms-3 mb-3"></div>
            <p className="text-start ms-3">Cirujano Hepatobiliar. Henri Bismuth Hepatobiliary Institute, Francia. 2019-2020</p>
            <h4 className="subtituloEstudios text-start ms-3 fs-md-3">PERFECCIONAMIENTO CONTINUO</h4>
            <div className="divider bg-danger ms-3 mb-3"></div>
            ...
            <h4 className="subtituloEstudios text-start ms-3 fs-md-3 fs-sm-5">PUBLICACIONES RELEVANTE</h4>
            <div className="divider bg-danger ms-3 mb-3"></div>
