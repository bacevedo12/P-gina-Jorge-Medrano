    ...
    return (
        <section className="border-top border-bottom border-bottom-light border-top-light border-3 preguntasFrecuentes">
            <div className="tituloCirugia">
                <h1 className="pt-5 pb-4 fw-bold">Cirugía Hepatobiliar y Pancreática</h1>
                <h3 className="pb-5 fw-bold">Subespecialidad en Cirugía General</h3>
            ...
            <div className=" m-5 border border-white">
            <div>
